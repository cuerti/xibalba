...
Xibalba is a networking tool focused on those who use VPN connections most part of the day and wanted to be sure that their secure connection is always alive.

It all started with me looking for some app that could monitor my VPN connections and implements a KillSwitch when any of them fail. After a while I couldn't find nothing that implement this in a secure way, so this project is my take at creating one.
...
> For bugfixes or new features ideas/suggestions feel free to contact me at eif0@hush.com
...
You can also download Xibalba's sources from [GitHub archive](https://github.com/cuerti/xibalba/archive/master.zip).
...
Also, as said before, my email is always available for suggestions and ideas.
